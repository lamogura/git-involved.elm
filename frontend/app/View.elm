        ...
        [ div [ class "mdl-layout__container has-scrolling-header" ]
            [ div [ class "mdl-layout mdl-layout--fixed-header" ]
                [ Html.header [ class "mdl-layout__header mdl-layout__header--scroll mdl-color--primary" ]
                    ...
                    , div [ class "mdl-layout--large-screen-only mdl-layout__header-row", style [ ( "justify-content", "center" ) ] ]
                        [ Html.h3 [] [ text "Help out on some OPEN SOURCE projects" ] ]
                    , div [ class "mdl-layout--large-screen-only mdl-layout__header-row" ] []
                    ]
                , Html.main_ [ class "mdl-layout__content mdl-color--grey-100" ]
                    [ Html.section [ class "section--center mdl-color--white mdl-grid" ]
    ...
    div [ class "git-issue-card mdl-cell--12-col mdl-shadow--2dp" ]
        [ div [ class "git-issue mdl-cell--9-col" ]
            [ div [ class "mdl-card__supporting-text" ]
                [ Html.h4 [ class "issue-title" ] [ text issue.title ]
