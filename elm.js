...
var _moarwick$elm_webpack_starter$Models$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {issuesSearchResult: a, route: b, autocompleteState: c, selectedLanguage: d, showLanguageMenu: e, languageQuery: f, orderIssuesBy: g, mdl: h};
	});
var _moarwick$elm_webpack_starter$Models$IssueSearchResult = F2(
	function (a, b) {
		return {totalCount: a, issues: b};
	});
var _moarwick$elm_webpack_starter$Models$Issue = F8(
	function (a, b, c, d, e, f, g, h) {
		return {title: a, body: b, commentCount: c, repository_url: d, labels: e, id: f, createdAt: g, updatedAt: h};
	});
var _moarwick$elm_webpack_starter$Models$Label = F2(
	function (a, b) {
		return {name: a, color: b};
	});
var _moarwick$elm_webpack_starter$Models$MostPopular = {ctor: 'MostPopular'};
var _moarwick$elm_webpack_starter$Models$LastUpdated = {ctor: 'LastUpdated'};
var _moarwick$elm_webpack_starter$Models$initialModel = function (route) {
	return {
		issuesSearchResult: _krisajenkins$remotedata$RemoteData$Loading,
		route: route,
		autocompleteState: _thebritican$elm_autocomplete$Autocomplete$empty,
		selectedLanguage: _elm_lang$core$Maybe$Just('Javascript'),
		showLanguageMenu: false,
		languageQuery: 'Javascript',
		orderIssuesBy: _moarwick$elm_webpack_starter$Models$LastUpdated,
		mdl: _debois$elm_mdl$Material$model
	};
};
var _moarwick$elm_webpack_starter$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _moarwick$elm_webpack_starter$Models$AboutPage = {ctor: 'AboutPage'};
var _moarwick$elm_webpack_starter$Models$MainPage = {ctor: 'MainPage'};

var _moarwick$elm_webpack_starter$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _moarwick$elm_webpack_starter$Models$MainPage, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_moarwick$elm_webpack_starter$Models$AboutPage,
				_evancz$url_parser$UrlParser$s('about')),
			_1: {ctor: '[]'}
		}
	});
var _moarwick$elm_webpack_starter$Routing$parseLocation = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parseHash, _moarwick$elm_webpack_starter$Routing$matchers, location);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return _moarwick$elm_webpack_starter$Models$NotFoundRoute;
	}
};

var _moarwick$elm_webpack_starter$Messages$HandleEscape = {ctor: 'HandleEscape'};
var _moarwick$elm_webpack_starter$Messages$NoOp = {ctor: 'NoOp'};
var _moarwick$elm_webpack_starter$Messages$SelectLanguageKeyboard = function (a) {
	return {ctor: 'SelectLanguageKeyboard', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$Wrap = function (a) {
	return {ctor: 'Wrap', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$Reset = {ctor: 'Reset'};
var _moarwick$elm_webpack_starter$Messages$SelectLanguageMouse = function (a) {
	return {ctor: 'SelectLanguageMouse', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$PreviewLanguage = function (a) {
	return {ctor: 'PreviewLanguage', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$SetQuery = function (a) {
	return {ctor: 'SetQuery', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$SetAutoState = function (a) {
	return {ctor: 'SetAutoState', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$SetOrderIssuesBy = function (a) {
	return {ctor: 'SetOrderIssuesBy', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$GoToMainPage = {ctor: 'GoToMainPage'};
var _moarwick$elm_webpack_starter$Messages$GoToAboutPage = {ctor: 'GoToAboutPage'};
var _moarwick$elm_webpack_starter$Messages$OnFetchIssues = function (a) {
	return {ctor: 'OnFetchIssues', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$OnLocationChange = function (a) {
...
var _moarwick$elm_webpack_starter$Commands$labelDecoder = A3(
	...
	A3(
		...
		'name',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_moarwick$elm_webpack_starter$Models$Label)));
var _moarwick$elm_webpack_starter$Commands$repoNameFromUrl = function (url) {
	var urlParamsList = _elm_lang$core$List$reverse(
		A2(_elm_lang$core$String$split, '/', url));
	var _p0 = urlParamsList;
	if ((_p0.ctor === '::') && (_p0._1.ctor === '::')) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_p0._0,
			A2(_elm_lang$core$Basics_ops['++'], ' by ', _p0._1._0));
	} else {
		return 'wrong repo url';
	}
};
var _moarwick$elm_webpack_starter$Commands$dateFrom = function (sqlFormatDate) {
	var _p1 = _elm_lang$core$Date$fromString(sqlFormatDate);
	if (_p1.ctor === 'Ok') {
		var _p2 = _p1._0;
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _moarwick$elm_webpack_starter$Commands$issueDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'updated_at',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'labels',
				_elm_lang$core$Json_Decode$list(_moarwick$elm_webpack_starter$Commands$labelDecoder),
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'repository_url',
					_elm_lang$core$Json_Decode$string,
...
var _moarwick$elm_webpack_starter$Commands$issueSearchResultDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'items',
	_elm_lang$core$Json_Decode$list(_moarwick$elm_webpack_starter$Commands$issueDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'total_count',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_moarwick$elm_webpack_starter$Models$IssueSearchResult)));
var _moarwick$elm_webpack_starter$Commands$fetchIssues = function (language) {
	var queryLanguage = _elm_lang$core$String$toLower(
		A2(_elm_lang$core$Maybe$withDefault, 'Javascript', language));
	var request = _elm_lang$http$Http$request(
		{
			...
			url: A2(
				_elm_lang$core$Basics_ops['++'],
				'https://api.github.com/search/issues?q=language:',
				A2(_elm_lang$core$Basics_ops['++'], queryLanguage, '+is:open&sort=updated')),
			body: A2(_elm_lang$http$Http$stringBody, 'application/json', '{}'),
			expect: _elm_lang$http$Http$expectJson(_moarwick$elm_webpack_starter$Commands$issueSearchResultDecoder),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_moarwick$elm_webpack_starter$Messages$OnFetchIssues,
		_krisajenkins$remotedata$RemoteData$sendRequest(request));
};

var _moarwick$elm_webpack_starter$Update$allLanguages = {
	ctor: '::',
	_0: 'Javascript',
	_1: {
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Update$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
		toId: _elm_lang$core$Basics$identity,
		onKeyDown: F2(
			function (code, maybeId) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(_elm_lang$core$Maybe$map, _moarwick$elm_webpack_starter$Messages$PreviewLanguage, maybeId) : (_elm_lang$core$Native_Utils.eq(code, 13) ? A2(_elm_lang$core$Maybe$map, _moarwick$elm_webpack_starter$Messages$SelectLanguageKeyboard, maybeId) : _elm_lang$core$Maybe$Just(_moarwick$elm_webpack_starter$Messages$Reset));
			}),
		onTooLow: _elm_lang$core$Maybe$Just(
			_moarwick$elm_webpack_starter$Messages$Wrap(false)),
		onTooHigh: _elm_lang$core$Maybe$Just(
			_moarwick$elm_webpack_starter$Messages$Wrap(true)),
		onMouseEnter: function (id) {
			return _elm_lang$core$Maybe$Just(
				_moarwick$elm_webpack_starter$Messages$PreviewLanguage(id));
		},
		...
		onMouseClick: function (id) {
			return _elm_lang$core$Maybe$Just(
				_moarwick$elm_webpack_starter$Messages$SelectLanguageMouse(id));
		},
		separateSelections: false
	});
var _moarwick$elm_webpack_starter$Update$languageMatches = function (query) {
	...
	return A2(
		...
		_moarwick$elm_webpack_starter$Update$allLanguages);
};
var _moarwick$elm_webpack_starter$Update$resetLanguageMenu = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{autocompleteState: _thebritican$elm_autocomplete$Autocomplete$empty, showLanguageMenu: false});
};
var _moarwick$elm_webpack_starter$Update$removeSelectedLanguage = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{selectedLanguage: _elm_lang$core$Maybe$Nothing});
};
var _moarwick$elm_webpack_starter$Update$resetInput = function (model) {
	return _moarwick$elm_webpack_starter$Update$resetLanguageMenu(
		_moarwick$elm_webpack_starter$Update$removeSelectedLanguage(
			_elm_lang$core$Native_Utils.update(
				model,
				{languageQuery: ''})));
};
var _moarwick$elm_webpack_starter$Update$getLanguageAtId = function (id) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'Javascript',
		_elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (language) {
					return _elm_lang$core$Native_Utils.eq(language, id);
				},
				_moarwick$elm_webpack_starter$Update$allLanguages)));
};
var _moarwick$elm_webpack_starter$Update$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				languageQuery: _moarwick$elm_webpack_starter$Update$getLanguageAtId(id),
				selectedLanguage: _elm_lang$core$Maybe$Just(
					_moarwick$elm_webpack_starter$Update$getLanguageAtId(id))
			});
	});
var _moarwick$elm_webpack_starter$Update$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p2 = msg;
			switch (_p2.ctor) {
				case 'OnLocationChange':
					var newRoute = _moarwick$elm_webpack_starter$Routing$parseLocation(_p2._0);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'OnFetchIssues':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{issuesSearchResult: _p2._0}),
						{ctor: '[]'});
				case 'Mdl':
					return A3(_debois$elm_mdl$Material$update, _moarwick$elm_webpack_starter$Messages$Mdl, _p2._0, model);
				case 'SetOrderIssuesBy':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{orderIssuesBy: _p2._0}),
						{ctor: '[]'});
				case 'SetQuery':
					var _p4 = _p2._0;
					var showMenu = function (_p3) {
						...
						_moarwick$elm_webpack_starter$Update$languageMatches(_p4));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{languageQuery: _p4, showLanguageMenu: showMenu, selectedLanguage: _elm_lang$core$Maybe$Nothing}),
						{ctor: '[]'});
				case 'SetAutoState':
					var _p5 = A5(
						_thebritican$elm_autocomplete$Autocomplete$update,
						_moarwick$elm_webpack_starter$Update$updateConfig,
						_p2._0,
						5,
						model.autocompleteState,
						_moarwick$elm_webpack_starter$Update$languageMatches(model.languageQuery));
					var newState = _p5._0;
					var maybeMsg = _p5._1;
				...
				case 'SelectLanguageKeyboard':
					var newModel = _moarwick$elm_webpack_starter$Update$resetLanguageMenu(
						A2(_moarwick$elm_webpack_starter$Update$setQuery, model, _p2._0));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Commands$fetchIssues(newModel.selectedLanguage),
							_1: {ctor: '[]'}
						});
				case 'SelectLanguageMouse':
					var newModel = _moarwick$elm_webpack_starter$Update$resetLanguageMenu(
						A2(_moarwick$elm_webpack_starter$Update$setQuery, model, _p2._0));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						{
							...
							_0: A2(
								...
								_elm_lang$dom$Dom$focus('autocomplete-input')),
							_1: {
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Commands$fetchIssues(newModel.selectedLanguage),
								_1: {ctor: '[]'}
				...
				case 'Wrap':
					var _p8 = model.selectedLanguage;
					if (_p8.ctor === 'Just') {
						var _v5 = _moarwick$elm_webpack_starter$Messages$Reset,
							_v6 = model;
						msg = _v5;
						model = _v6;
						continue update;
						...
						return _p2._0 ? A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									autocompleteState: A4(
										_thebritican$elm_autocomplete$Autocomplete$resetToLastItem,
										_moarwick$elm_webpack_starter$Update$updateConfig,
										_moarwick$elm_webpack_starter$Update$languageMatches(model.languageQuery),
										5,
										model.autocompleteState),
									selectedLanguage: _elm_lang$core$List$head(
										_elm_lang$core$List$reverse(
											_moarwick$elm_webpack_starter$Update$languageMatches(model.languageQuery)))
								}),
							{ctor: '[]'}) : A2(
				...
				case 'Reset':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								autocompleteState: A2(_thebritican$elm_autocomplete$Autocomplete$reset, _moarwick$elm_webpack_starter$Update$updateConfig, model.autocompleteState),
								selectedLanguage: _elm_lang$core$Maybe$Nothing
							}),
						{ctor: '[]'});
				case 'PreviewLanguage':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								selectedLanguage: _elm_lang$core$Maybe$Just(
									_moarwick$elm_webpack_starter$Update$getLanguageAtId(_p2._0))
							}),
						{ctor: '[]'});
				case 'HandleEscape':
					var validOptions = !_elm_lang$core$List$isEmpty(
						_moarwick$elm_webpack_starter$Update$languageMatches(model.languageQuery));
					var handleEscape = validOptions ? _moarwick$elm_webpack_starter$Update$resetLanguageMenu(
						_moarwick$elm_webpack_starter$Update$removeSelectedLanguage(model)) : _moarwick$elm_webpack_starter$Update$resetLanguageMenu(
						_moarwick$elm_webpack_starter$Update$removeSelectedLanguage(
							_elm_lang$core$Native_Utils.update(
								model,
								{languageQuery: ''})));
					var escapedModel = function () {
						var _p9 = model.selectedLanguage;
						if (_p9.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(model.languageQuery, _p9._0) ? _moarwick$elm_webpack_starter$Update$resetInput(model) : handleEscape;
						} else {
							return handleEscape;
						}
					}();
	...
	_1: {
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'padding', _1: '0.8em'},
					_1: {
						ctor: '::',
...
var _moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$itemStyles = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'display', _1: 'block'},
	_1: {
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$listStyles = {
	ctor: '::',
...
var _moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$selectedItemStyles = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'background', _1: '#3366FF'},
	_1: {
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$menuStyles = {
	ctor: '::',
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'z-index', _1: '11110'},
				_1: {ctor: '[]'}
			}
		}
	}
...
var _moarwick$elm_webpack_starter$View$aboutPage = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_moarwick$elm_webpack_starter$Messages$GoToMainPage),
							_1: {
								ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Go To Main Page'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	return A3(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('mdl-chip__text'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _moarwick$elm_webpack_starter$View$mdlMenu = function (mdlModel) {
	return A5(
		_debois$elm_mdl$Material_Menu$render,
		_moarwick$elm_webpack_starter$Messages$Mdl,
		{
			ctor: '::',
			_0: 1,
			_1: {
			...
			_0: A2(
				_debois$elm_mdl$Material_Menu$item,
				{
					...
					_0: _debois$elm_mdl$Material_Menu$onSelect(
						_moarwick$elm_webpack_starter$Messages$SetOrderIssuesBy(_moarwick$elm_webpack_starter$Models$LastUpdated)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Last updated'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_debois$elm_mdl$Material_Menu$item,
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Menu$onSelect(
							_moarwick$elm_webpack_starter$Messages$SetOrderIssuesBy(_moarwick$elm_webpack_starter$Models$MostPopular)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Most popular'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _moarwick$elm_webpack_starter$View$viewConfig = function () {
	var customizedLi = F3(
		function (keySelected, mouseSelected, language) {
			return {
				attributes: {
					ctor: '::',
					_0: (keySelected || mouseSelected) ? _elm_lang$html$Html_Attributes$style(_moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$selectedItemStyles) : _elm_lang$html$Html_Attributes$style(_moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$itemStyles),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(language),
						_1: {ctor: '[]'}
					}
				},
				children: {
	...
	return _thebritican$elm_autocomplete$Autocomplete$viewConfig(
		{
			...
			ul: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(_moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$listStyles),
				_1: {ctor: '[]'}
			},
			li: customizedLi
		});
}();
var _moarwick$elm_webpack_starter$View$viewMenu = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_moarwick$elm_webpack_starter$Autocomplete_DefaultStyles$menuStyles),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$map,
				_moarwick$elm_webpack_starter$Messages$SetAutoState,
				A4(
					_thebritican$elm_autocomplete$Autocomplete$view,
					_moarwick$elm_webpack_starter$View$viewConfig,
					5,
					model.autocompleteState,
					_moarwick$elm_webpack_starter$Update$languageMatches(model.languageQuery))),
			_1: {ctor: '[]'}
...
var _moarwick$elm_webpack_starter$View$autoComplete = function (model) {
	var query = function () {
		var _p0 = model.selectedLanguage;
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
			return model.languageQuery;
		}
	}();
	var menu = model.showLanguageMenu ? {
		ctor: '::',
		_0: _moarwick$elm_webpack_starter$View$viewMenu(model),
		_1: {ctor: '[]'}
	} : {ctor: '[]'};
	...
	var dec = A2(
		...
		A2(
			_elm_lang$core$Json_Decode$map,
			function (code) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(_moarwick$elm_webpack_starter$Messages$NoOp) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(_moarwick$elm_webpack_starter$Messages$HandleEscape) : _elm_lang$core$Result$Err('not handling that key'));
			},
			_elm_lang$html$Html_Events$keyCode));
		...
		A2(
			_elm_lang$core$List$append,
			{
				...
				_0: A5(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Textfield$label('Show me repos using'),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onInput(_moarwick$elm_webpack_starter$Messages$SetQuery),
										_1: {
											ctor: '::',
...
var _moarwick$elm_webpack_starter$View$issueCardAction = function (issue) {
	return A3(
		_debois$elm_mdl$Material_Options$styled,
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$cs('p2'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_moarwick$elm_webpack_starter$Commands$dateFrom(issue.createdAt),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' - ',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(issue.commentCount),
								' comments'))))),
			_1: {ctor: '[]'}
		});
};
var _moarwick$elm_webpack_starter$View$issueDiv = F2(
	function (issue, mdl) {
		return A3(
			_debois$elm_mdl$Material_Options$styled,
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Options$cs('issue-card fit rounded flex my3 mdl-shadow--2dp mdl-color--white'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('content col col-10'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A3(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$cs('fit py0 px3 mdl-card__supporting-text'),
								_1: {
									ctor: '::',
							...
							},
							{
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$cs('mt2'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A3(
										...
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$cs('body overflow-hidden'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$core$String$isEmpty(issue.body) ? _elm_lang$html$Html$text('No description') : _elm_lang$html$Html$text(issue.body),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_0: A3(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$cs('flex items-center mdl-card__actions'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _moarwick$elm_webpack_starter$View$issueCardAction(issue),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
											{ctor: '[]'},
											A2(_elm_lang$core$List$map, _moarwick$elm_webpack_starter$View$labelDiv, issue.labels)),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A3(
						...
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$cs('repo fit p2 col col-2 xs-hide'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'overflow-wrap', 'break-word'),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_moarwick$elm_webpack_starter$Commands$repoNameFromUrl(issue.repository_url)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _moarwick$elm_webpack_starter$View$maybeIssueSearchResult = function (model) {
	var _p2 = model.issuesSearchResult;
	switch (_p2.ctor) {
		case 'NotAsked':
			return {
				ctor: '::',
		...
		case 'Success':
			return A2(
				...
				A2(_elm_lang$core$List$map, _moarwick$elm_webpack_starter$View$issueDiv, _p2._0.issues));
		default:
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text(
...
var _moarwick$elm_webpack_starter$View$mainPage = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('page-layout mdl-color--grey-200'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A3(
						...
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$cs('p1 mdl-color--primary'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'color', 'rgb(255,255,255)'),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A3(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$cs('m2'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Git-Back'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A3(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$cs('mt4 center'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Contribute to open source'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A3(
										...
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$cs('mb4 center'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Help out on unassigned open issues'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
					...
					_1: {
						...
						_0: A3(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$cs('p2 mx-auto max-width-4'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A3(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$cs('flex flex-wrap justify-center'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _moarwick$elm_webpack_starter$View$autoComplete(model),
										_1: {
											ctor: '::',
											_0: A3(
												_debois$elm_mdl$Material_Options$styled,
												...
												{
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$cs('mt3 ml2 flex'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Order by:'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															_elm_lang$core$Basics$toString(model.orderIssuesBy)),
														_1: {
															ctor: '::',
															_0: _moarwick$elm_webpack_starter$View$mdlMenu(model.mdl),
															_1: {ctor: '[]'}
														}
													}
												}),
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										_moarwick$elm_webpack_starter$View$maybeIssueSearchResult(model)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _moarwick$elm_webpack_starter$View$page = function (model) {
	...
	switch (_p3.ctor) {
		...
		case 'AboutPage':
			return _moarwick$elm_webpack_starter$View$aboutPage;
		default:
...
var _moarwick$elm_webpack_starter$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _moarwick$elm_webpack_starter$View$page(model),
			_1: {ctor: '[]'}
		});
};

var _moarwick$elm_webpack_starter$App$subscriptions = function (model) {
	return A2(_elm_lang$core$Platform_Sub$map, _moarwick$elm_webpack_starter$Messages$SetAutoState, _thebritican$elm_autocomplete$Autocomplete$subscription);
};
var _moarwick$elm_webpack_starter$App$init = function (location) {
	var currentRoute = _moarwick$elm_webpack_starter$Routing$parseLocation(location);
	var initModel = _moarwick$elm_webpack_starter$Models$initialModel(currentRoute);
	return {
		ctor: '_Tuple2',
		_0: initModel,
		_1: _moarwick$elm_webpack_starter$Commands$fetchIssues(initModel.selectedLanguage)
	};
};
var _moarwick$elm_webpack_starter$App$main = A2(
	_elm_lang$navigation$Navigation$program,
	_moarwick$elm_webpack_starter$Messages$OnLocationChange,
	{init: _moarwick$elm_webpack_starter$App$init, view: _moarwick$elm_webpack_starter$View$view, update: _moarwick$elm_webpack_starter$Update$update, subscriptions: _moarwick$elm_webpack_starter$App$subscriptions})();

var Elm = {};
Elm['App'] = Elm['App'] || {};
if (typeof _moarwick$elm_webpack_starter$App$main !== 'undefined') {
    _moarwick$elm_webpack_starter$App$main(Elm['App'], 'App', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Material.Component.Msg":{"args":["button","textfield","menu","layout","toggles","tooltip","tabs","dispatch"],"tags":{"TooltipMsg":["Material.Component.Index","tooltip"],"TogglesMsg":["Material.Component.Index","toggles"],"LayoutMsg":["layout"],"ButtonMsg":["Material.Component.Index","button"],"MenuMsg":["Material.Component.Index","menu"],"TabsMsg":["Material.Component.Index","tabs"],"Dispatch":["dispatch"],"TextfieldMsg":["Material.Component.Index","textfield"]}},"Material.Ripple.Msg":{"args":[],"tags":{"Down":["Material.Ripple.DOMState"],"Up":[],"Tick":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Success":["a"],"Loading":[],"Failure":["e"]}},"Autocomplete.Msg":{"args":[],"tags":{"Msg":["Autocomplete.Autocomplete.Msg"]}},"Autocomplete.Autocomplete.Msg":{"args":[],"tags":{"MouseLeave":["String"],"WentTooHigh":[],"WentTooLow":[],"MouseClick":["String"],"KeyDown":["Char.KeyCode"],"NoOp":[],"MouseEnter":["String"]}},"Material.Tooltip.Msg":{"args":[],"tags":{"Enter":["Material.Tooltip.DOMState"],"Leave":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Json.Decode.Decoder":{"args":["a"],"tags":{"Decoder":[]}},"Messages.Message":{"args":[],"tags":{"OnLocationChange":["Navigation.Location"],"GoToAboutPage":[],"PreviewLanguage":["String"],"SelectLanguageMouse":["String"],"HandleEscape":[],"GoToMainPage":[],"Wrap":["Bool"],"SelectLanguageKeyboard":["String"],"OnFetchIssues":["RemoteData.WebData Models.IssueSearchResult"],"SetAutoState":["Autocomplete.Msg"],"Reset":[],"SetOrderIssuesBy":["Models.OrderIssuesBy"],"Mdl":["Material.Msg Messages.Message"],"SetQuery":["String"],"NoOp":[]}},"Models.OrderIssuesBy":{"args":[],"tags":{"LastUpdated":[],"MostPopular":[]}},"Material.Textfield.Msg":{"args":[],"tags":{"Focus":[],"Input":["String"],"Blur":[]}},"Material.Layout.Msg":{"args":[],"tags":{"Resize":["Int"],"ToggleDrawer":[],"TransitionEnd":[],"ScrollPane":["Bool","Float"],"Ripple":["Int","Material.Ripple.Msg"],"ScrollTab":["Material.Layout.TabScrollState"],"TransitionHeader":["{ toCompact : Bool, fixedHeader : Bool }"],"NOP":[]}},"Material.Toggles.Msg":{"args":[],"tags":{"Ripple":["Material.Ripple.Msg"],"SetFocus":["Bool"]}},"VirtualDom.Property":{"args":["msg"],"tags":{"Property":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Material.Tabs.Msg":{"args":[],"tags":{"Ripple":["Int","Material.Ripple.Msg"]}},"Material.Menu.Msg":{"args":["m"],"tags":{"Tick":[],"Close":[],"Open":["Material.Menu.Geometry.Geometry"],"Key":["List (Material.Options.Internal.Summary (Material.Menu.ItemConfig m) m)","Int"],"Ripple":["Int","Material.Ripple.Msg"],"Select":["Int","Maybe.Maybe m"],"Click":["Mouse.Position"]}},"Material.Dispatch.Config":{"args":["msg"],"tags":{"Config":["{ decoders : List ( String , ( Json.Decode.Decoder msg, Maybe.Maybe Html.Events.Options ) ) , lift : Maybe.Maybe (Json.Decode.Decoder (List msg) -> Json.Decode.Decoder msg) }"]}}},"aliases":{"Material.Button.Msg":{"args":[],"type":"Material.Ripple.Msg"},"Material.Layout.TabScrollState":{"args":[],"type":"{ canScrollLeft : Bool , canScrollRight : Bool , width : Maybe.Maybe Int }"},"Char.KeyCode":{"args":[],"type":"Int"},"Models.Label":{"args":[],"type":"{ name : String, color : String }"},"Material.Tooltip.DOMState":{"args":[],"type":"{ rect : DOM.Rectangle, offsetWidth : Float, offsetHeight : Float }"},"Html.Attribute":{"args":["msg"],"type":"VirtualDom.Property msg"},"Material.Menu.ItemConfig":{"args":["m"],"type":"{ enabled : Bool, divider : Bool, onSelect : Maybe.Maybe m }"},"Material.Component.Index":{"args":[],"type":"List Int"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Html.Events.Options":{"args":[],"type":"{ stopPropagation : Bool, preventDefault : Bool }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Material.Ripple.DOMState":{"args":[],"type":"{ rect : DOM.Rectangle , clientX : Maybe.Maybe Float , clientY : Maybe.Maybe Float , touchX : Maybe.Maybe Float , touchY : Maybe.Maybe Float , type_ : String }"},"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Material.Options.Internal.Summary":{"args":["c","m"],"type":"{ classes : List String , css : List ( String, String ) , attrs : List (Html.Attribute m) , internal : List (Html.Attribute m) , dispatch : Material.Dispatch.Config m , config : c }"},"Models.IssueSearchResult":{"args":[],"type":"{ totalCount : Int, issues : List Models.Issue }"},"Material.Msg":{"args":["m"],"type":"Material.Component.Msg Material.Button.Msg Material.Textfield.Msg (Material.Menu.Msg m) Material.Layout.Msg Material.Toggles.Msg Material.Tooltip.Msg Material.Tabs.Msg (List m)"},"Material.Menu.Geometry.Element":{"args":[],"type":"{ offsetTop : Float , offsetLeft : Float , offsetHeight : Float , bounds : DOM.Rectangle }"},"Models.Issue":{"args":[],"type":"{ title : String , body : String , commentCount : Int , repository_url : String , labels : List Models.Label , id : Int , createdAt : String , updatedAt : String }"},"Material.Menu.Geometry.Geometry":{"args":[],"type":"{ button : Material.Menu.Geometry.Element , menu : Material.Menu.Geometry.Element , container : Material.Menu.Geometry.Element , offsetTops : List Float , offsetHeights : List Float }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"},"DOM.Rectangle":{"args":[],"type":"{ top : Float, left : Float, width : Float, height : Float }"}},"message":"Messages.Message"},"versions":{"elm":"0.18.0"}});
}
